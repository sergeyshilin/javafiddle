...
import com.javafiddle.utils.Hashes;
...
public class ProjectRevisionGetter {
    ...
    public ProjectRevisionGetter(String hash) {
    ...
    public ProjectRevisionGetter(Hashes hashes) {
